...
- **Two props, unrelated to each other.** Coffee that had been on since the
  ...
  three across; the shoe with the sole going; the neon that buzzes one
...
it by nine. Sat on the roof after with a sandwich from the machine and the
game on a radio that only gets the away side's station. Down by six. The
pigeons had the better seats."*

*"Laundromat. Two a.m. The dryer with the bad bearing going round like it
had somewhere to be. I read the strip again under the fluorescents because
the office lamp had quit: every rule on the TALLOW file pass or not
